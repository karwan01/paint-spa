  ...
  newsItems: [
    {
      ...
      description: "Discover how our latest smart paint technology is revolutionizing the way homeowners and professionals approach interior design projects.",
    ...
    },
    {
      ...
      description: "Environmental consciousness drives demand for sustainable painting solutions.",
    ...
    },
    {
      ...
      description: "How choosing the right colors can impact mood and well-being.",
    ...
    },
    {
      ...
      description: "Learn expert tips and tricks to achieve professional-quality results.",
      image: "/news/news-1.png",
...
describe("News Component", () => {
  ...
  describe("Structure and Layout", () => {
    ...
    it("renders the news cards section with correct layout", () => {
      ...
      const cardsSection = document.querySelector(".flex.w-full.flex-col.gap-8");
  ...
  describe("Content Rendering", () => {
    ...
    it("renders the desktop 'View all news' button with correct styling", () => {
      ...
      const desktopButton = screen.getByRole("button", { name: "View all news" });
    ...
    it("renders the mobile 'Show all news' button with correct styling", () => {
      ...
      const mobileButton = screen.getByRole("button", { name: "Show all news" });
    ...
    it("renders the main news card", () => {
      ...
      expect(screen.getByText("Revolutionary Paint Technology Transforms Interior Design Industry")).toBeInTheDocument();
    });
    ...
    it("filters out main news from secondary cards", () => {
      ...
      const mainNewsTitle = screen.getAllByText("Revolutionary Paint Technology Transforms Interior Design Industry");
      expect(mainNewsTitle).toHaveLength(1);
      
      // Secondary news titles should appear
      expect(screen.getByText("Eco-Friendly Paint Solutions Gain Popularity")).toBeInTheDocument();
      expect(screen.getByText("Color Psychology in Modern Home Design")).toBeInTheDocument();
      expect(screen.getByText("Professional Painting Techniques for DIY Enthusiasts")).toBeInTheDocument();
    });
  });
  ...
  describe("Responsive Design", () => {
    ...
    it("applies correct responsive classes to main content area", () => {
      ...
      const secondaryNewsContainer = document.querySelector(".space-y-4.lg\\:flex-2");
  ...
  describe("Layout Structure", () => {
    it("arranges main and secondary news in correct flex layout", () => {
      ...
      const mainContainer = document.querySelector(".flex.w-full.flex-col.gap-8.lg\\:flex-row");
      expect(mainContainer).toBeInTheDocument();
      
      const mainNewsSection = mainContainer?.querySelector(".lg\\:flex-3");
      const secondaryNewsSection = mainContainer?.querySelector(".space-y-4.lg\\:flex-2");
    ...
    it("applies correct spacing between secondary news cards", () => {
      ...
      const secondaryContainer = document.querySelector(".space-y-4.lg\\:flex-2");
  ...
  describe("Accessibility", () => {
    ...
    it("provides accessible button labels", () => {
      ...
      expect(screen.getByRole("button", { name: "Show all news" })).toBeInTheDocument();
    });
  });
